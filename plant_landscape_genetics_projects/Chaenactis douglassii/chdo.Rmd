...
<button class="btn btn-link" data-toggle="collapse" data-target="#bcftools">bcftools code</button>
<div id="bcftools" class="collapse">   
<br>
...
<button class="btn btn-link" data-toggle="collapse" data-target="#geno_likelihood">G_likelihood code</button>
<div id="geno_likelihood" class="collapse">   
<br>
```{r eval=FALSE}
...
<button class="btn btn-link" data-toggle="collapse" data-target="#entropy">entropy_diploids code</button>
...
<button class="btn btn-link" data-toggle="collapse" data-target="#entropy">entropy_poliploids code</button>
<div id="entropy" class="collapse">   
<br>
```{r eval=FALSE}
require(readr)
...
*falta entropy como si todos fueran 2n a partir de k4 (se ve que falló)
