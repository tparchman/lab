...
### Example user add, for Delia Basanta

Use `sudo` to activate account, set working directory

    $ sudo useradd -m -s /bin/bash -c "Delia Basanta, Parchman Group" -G users,working dbasanta

this adds a new user, dbasanta:
